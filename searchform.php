...
<form  role="search" method="get" id="searchform" action="<?php echo home_url( '/' ); ?>">
    <div>
        <input type="text" type="text" size="26" maxlength="100" class="swap_value" value="" name="s" id="s" />
...
<form action="https://cn.bing.com/search" method="get" onsubmit="_submit()" class="search_k" target="_blank">    
    <input type="text" size="26" maxlength="100" class="swap_value" name="q" value="" placeholder="">
